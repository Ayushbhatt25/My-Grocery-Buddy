...
function Navbar() {
    ...
    const { user, setUser, navigate, setSearchQuery,
    ...
    return (
        <nav className="flex items-center justify-between px-4 md:px-8 lg:px-12 py-4 border-b border-white/10 bg-primary/90 backdrop-blur-xl relative transition-all z-50 shadow-lg shadow-black/20">
            ...
            <div className="hidden md:flex items-center gap-2 ml-7 text-black font-medium">
                ...
                <NavLink to="/" className="navbar-link">Contact</NavLink>
            ...
            <div className='flex items-center gap-6 sm:hidden'>
                ...
                <button onClick={() => setOpen(!open)} aria-label="Menu" className="p-2 rounded-lg hover:bg-white/10 transition-colors">
            ...
            {/* Mobile Menu */}
            {open && (
                <div className="absolute top-full left-0 w-full bg-gray-900/95 backdrop-blur-xl shadow-2xl border-t border-white/10 py-6 flex flex-col items-start gap-1 px-6 text-sm md:hidden text-gray-300 animate-in slide-in-from-top-5 duration-300">

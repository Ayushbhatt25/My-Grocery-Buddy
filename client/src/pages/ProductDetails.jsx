            ...
            <div className="flex flex-col md:flex-row gap-20 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        <button onClick={() => { addToCart(product._id); }} className="w-full py-3.5 btn-white-pink-shadow rounded-md" >
                            Add to Cart
                        </button>
                        <button onClick={() => { addToCart(product._id); navigate('/cart') }} className="w-full py-3.5 btn-buy-now rounded-md" >
                            Buy now
                        </button>
                    </div>
                </div>

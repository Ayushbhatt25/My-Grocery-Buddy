  ...
  return (
    <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between bg-transparent text-black">
      <div className="w-full md:p-10 p-4">
        ...
        <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white/90 border border-gray-200">
                  ...
                  <tr key={product._id} className="border-t border-gray-200">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-20 px-2 py-1 border border-gray-300 bg-white text-black rounded outline-none text-center focus:border-primary"
                        />
                        {state.editing && (
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-1 bg-gray-500 hover:bg-gray-600 text-white rounded-[5px] cursor-pointer"
                            >
                              Cancel
                            </button>
                          </div>
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="px-3 py-1 bg-red-500 hover:bg-red-600 text-white rounded-[5px] cursor-pointer text-sm"
                      >
                        Remove
                      </button>
                    </td>

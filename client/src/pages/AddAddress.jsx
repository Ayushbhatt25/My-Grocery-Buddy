...
const InputField = ({ type, placeholder, name, handleChange, address }) => (
    <input className='w-full px-2 py-2.5 bg-gray-800 border border-gray-600 rounded outline-none text-white placeholder-gray-400 focus:border-primary transition'
